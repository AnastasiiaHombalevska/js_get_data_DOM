...
totalPopulationElement.innerHTML = convertAmountWithThousandsSeparator(totalPopulationAmount);
const averagePopulationElement = document.querySelector("span.average-population");
const averagePopulationAmount = getTotalAmountPopulation(populationList) / populationList.length;
averagePopulationElement.innerHTML = convertAmountWithThousandsSeparator(averagePopulationAmount);
